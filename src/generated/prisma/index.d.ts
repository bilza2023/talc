...
export namespace Prisma {
  ...
  */
  ...
  export type DeckOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "filename" | "content" | "createdAt", ExtArgs["result"]["deck"]>
  ...
  interface DeckFieldRefs {
    ...
    readonly filename: FieldRef<"Deck", 'String'>
    readonly content: FieldRef<"Deck", 'Json'>
  ...
  export type DeckWhereInput = {
    ...
    filename?: StringFilter<"Deck"> | string
    content?: JsonFilter<"Deck">
  ...
  export type DeckScalarWhereWithAggregatesInput = {
    ...
    filename?: StringWithAggregatesFilter<"Deck"> | string
    content?: JsonWithAggregatesFilter<"Deck">
