...
export function numOr(def, v, { min, max } = {}) {
  // Key fix: treat null/empty as "no value" -> use default
...
export async function paginateQuery(delegate, opts = {}) {
  ...
  return {
    rows,
    paging: { page, pageSize, total, totalPages, hasPrev: page > 1, hasNext }
  };
}
