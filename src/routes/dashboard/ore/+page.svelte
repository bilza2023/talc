<!-- /src/routes/dashboard/ore/+page.svelte -->
<script>
  export let data;
...
<div class="min-h-screen bg-[#0b1018] text-[#e6ebf1]">
  <div class="mx-auto max-w-7xl p-6 space-y-8">
    ...
    <header class="space-y-1">
      <h1 class="text-2xl font-semibold">Ore — Dashboard</h1>
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
        <div class="text-sm text-[#9fb0c5]">Shipments In-Transit</div>
