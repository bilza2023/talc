<!-- /home/bilal-tariq/ab/src/routes/dashboard/ore/+page.svelte -->
<script>
  export let data;
...
<div class="min-h-screen bg-gradient-to-b from-[#0a0d13] to-[#0b1018] text-[#e6ebf1]">
  <div class="mx-auto max-w-7xl px-4 py-8 space-y-8">
    <header class="space-y-2">
      <h1 class="text-2xl font-semibold tracking-tight">Ore — Global Dashboard</h1>
    ...
    <!-- Per-station × Per-grade Matrix (t and %) -->
    <section class="space-y-3">
                ...
                <tr class="even:bg-white/[0.03] align-top">
                  ...
                  {#each gradeMatrix.grades as g}
                    <td class="px-4 py-3 whitespace-nowrap">
                      <div class="font-semibold">{fmtTon(row.byGrade[g])} <span class="text-xs font-normal">t</span></div>
