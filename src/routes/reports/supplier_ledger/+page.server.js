// Purchase Ledger — simple ListTable feed (no grouping, no search)
// Source: purchase_tbl
// NOTE: prisma import per your instruction
...
export async function load() {
  ...
  const items = rows.map(r => ({
    id: r.id, // cuid (unique rowKey)
    docDate: r.docDate ? r.docDate.toISOString() : null, // ISO for kind:'date'
