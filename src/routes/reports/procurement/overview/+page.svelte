...
<ReportShell title="Procurement — Overview" dateRange="Live Data" {tabs}>
  <KPIBar items={kpis} />
  ...
  <h2 style="margin:1.25rem 0 .5rem;">Station × Family (Purchases in Period)</h2>
  <SmartTable columns={heatCols} rows={heatRows} />

  <h2 style="margin:1.25rem 0 .5rem;">Supplier Leaderboard (Period)</h2>
  <SmartTable columns={lbCols} rows={leaderboard} />

  <h2 style="margin:1.25rem 0 .5rem;">Recent Purchases</h2>
  <SmartTable columns={recentCols} rows={recentRows} />
</ReportShell>
